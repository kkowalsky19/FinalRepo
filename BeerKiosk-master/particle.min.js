(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Particle = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    },{"babel-runtime/core-js/object/get-prototype-of":14,"babel-runtime/core-js/promise":17,"babel-runtime/helpers/classCallCheck":20,"babel-runtime/helpers/createClass":21,"babel-runtime/helpers/inherits":22,"babel-runtime/helpers/possibleConstructorReturn":23,"events":137,"http":164,"https":164,"url":178}],5:[function(require,module,exports){
    ...
    "use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _assign=require("babel-runtime/core-js/object/assign"),_assign2=_interopRequireDefault(_assign),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_superagentBinaryParser=require("./superagent-binary-parser"),_superagentBinaryParser2=_interopRequireDefault(_superagentBinaryParser),_Defaults=require("./Defaults"),_Defaults2=_interopRequireDefault(_Defaults),_EventStream=require("./EventStream"),_EventStream2=_interopRequireDefault(_EventStream),_Agent=require("./Agent"),_Agent2=_interopRequireDefault(_Agent),_Client=require("./Client"),_Client2=_interopRequireDefault(_Client),Particle=function(){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};(0,_classCallCheck3.default)(this,e),(0,_assign2.default)(this,_Defaults2.default,t),this.context={},this.agent=new _Agent2.default(this.baseUrl)}return(0,_createClass3.default)(e,[{key:"_isValidContext",value:function(e,t){return("tool"===e||"project"===e)&&void 0!==t}},{key:"setContext",value:function(e,t){if(void 0!==t){if(!this._isValidContext(e,t))throw Error("uknown context name or undefined context: "+e);this.context[e]=t}}},{key:"_buildContext",value:function(e){return(0,_assign2.default)(this.context,e)}},{key:"login",value:function(e){var t=e.username,r=e.password,i=e.tokenDuration,n=void 0===i?this.tokenDuration:i,o=e.context;return this.request({uri:"/oauth/token",form:{username:t,password:r,grant_type:"password",client_id:this.clientId,client_secret:this.clientSecret,expires_in:n},method:"post",context:o})}},{key:"sendOtp",value:function(e){var t=e.mfaToken,r=e.otp,i=e.context;return this.request({uri:"/oauth/token",form:{grant_type:"urn:custom:mfa-otp",mfa_token:t,otp:r,client_id:this.clientId,client_secret:this.clientSecret},method:"post",context:i})}},{key:"enableMfa",value:function(e){var t=e.auth,r=e.context;return this.get("/v1/user/mfa-enable",t,void 0,r)}},{key:"confirmMfa",value:function(e){var t=e.auth,r=e.mfaToken,i=e.otp,n=e.context;return this.post("/v1/user/mfa-enable",{mfa_token:r,otp:i},t,n)}},{key:"disableMfa",value:function(e){var t=e.auth,r=e.currentPassword,i=e.context;return this.put("/v1/user/mfa-disable",{current_password:r},t,i)}},{key:"createCustomer",value:function(e){var t=e.email,r=e.password,i=e.product,n=e.context,o="/v1/products/"+i+"/customers";return this.request({uri:o,form:{email:t,password:r,grant_type:"client_credentials",client_id:this.clientId,client_secret:this.clientSecret},method:"post",context:n})}},{key:"loginAsClientOwner",value:function(e){var t=e.context;return this.request({uri:"/oauth/token",form:{grant_type:"client_credentials",client_id:this.clientId,client_secret:this.clientSecret},method:"post",context:t})}},{key:"createUser",value:function(e){var t=e.username,r=e.password,i=e.accountInfo,n=e.context;return this.post("/v1/users",{username:t,password:r,account_info:i},void 0,n)}},{key:"verifyUser",value:function(e){var t=e.token,r=e.context;return this.post("/v1/user/verify",{token:t},void 0,r)}},{key:"resetPassword",value:function(e){var t=e.username,r=e.context;return this.post("/v1/user/password-reset",{username:t},void 0,r)}},{key:"deleteAccessToken",value:function(e){var t=e.username,r=e.password,i=e.token,n=e.context;return this.delete("/v1/access_tokens/"+i,{access_token:i},{username:t,password:r},n)}},{key:"deleteCurrentAccessToken",value:function(e){var t=e.auth,r=e.context;return this.delete("/v1/access_tokens/current",void 0,t,r)}},{key:"deleteUser",value:function(e){var t=e.auth,r=e.context,i=e.password;return this.delete("/v1/user",{password:i},t,r)}},{key:"listAccessTokens",value:function(e){var t=e.username,r=e.password,i=e.context;return this.get("/v1/access_tokens",{username:t,password:r},void 0,i)}},{key:"trackingIdentity",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=e.auth,r=e.full,i=void 0!==r&&r,n=e.context;return this.get("/v1/user/identify",t,i?void 0:{tracking:1},n)}},{key:"listDevices",value:function(e){var t=e.deviceId,r=e.deviceName,i=e.groups,n=e.sortAttr,o=e.sortDir,u=e.page,a=e.perPage,s=e.product,c=e.auth,d=e.context,v=void 0,l=void 0;return s?(v="/v1/products/"+s+"/devices",i=Array.isArray(i)?i.join(","):void 0,l={deviceId:t,deviceName:r,groups:i,sortAttr:n,sortDir:o,page:u,per_page:a}):v="/v1/devices",this.get(v,c,l,d)}},{key:"getDevice",value:function(e){var t=e.deviceId,r=e.product,i=e.auth,n=e.context,o=this.deviceUri({deviceId:t,product:r});return this.get(o,i,void 0,n)}},{key:"claimDevice",value:function(e){var t=e.deviceId,r=e.requestTransfer,i=e.auth,n=e.context;return this.post("/v1/devices",{id:t,request_transfer:!!r},i,n)}},{key:"addDeviceToProduct",value:function(e){var t=e.deviceId,r=e.product,i=e.file,n=e.auth,o=e.context,u=void 0,a=void 0;return i?u={file:i}:t&&(a={id:t}),this.request({uri:"/v1/products/"+r+"/devices",method:"post",data:a,files:u,auth:n,context:o})}},{key:"removeDevice",value:function(e){var t=e.deviceId,r=e.deny,i=e.product,n=e.auth,o=e.context,u=this.deviceUri({deviceId:t,product:i}),a=i?{deny:r}:void 0;return this.delete(u,a,n,o)}},{key:"removeDeviceOwner",value:function(e){var t=e.deviceId,r=e.product,i=e.auth,n=e.context,o="/v1/products/"+r+"/devices/"+t+"/owner";return this.delete(o,void 0,i,n)}},{key:"renameDevice",value:function(e){var t=e.deviceId,r=e.name,i=e.product,n=e.auth,o=e.context;return this.updateDevice({deviceId:t,name:r,product:i,auth:n,context:o})}},{key:"signalDevice",value:function(e){var t=e.deviceId,r=e.signal,i=e.product,n=e.auth,o=e.context;return this.updateDevice({deviceId:t,signal:r,product:i,auth:n,context:o})}},{key:"setDeviceNotes",value:function(e){var t=e.deviceId,r=e.notes,i=e.product,n=e.auth,o=e.context;return this.updateDevice({deviceId:t,notes:r,product:i,auth:n,context:o})}},{key:"markAsDevelopmentDevice",value:function(e){var t=e.deviceId,r=e.development,i=void 0===r||r,n=e.product,o=e.auth,u=e.context;return this.updateDevice({deviceId:t,development:i,product:n,auth:o,context:u})}},{key:"lockDeviceProductFirmware",value:function(e){var t=e.deviceId,r=e.desiredFirmwareVersion,i=e.flash,n=e.product,o=e.auth,u=e.context;return this.updateDevice({deviceId:t,desiredFirmwareVersion:r,flash:i,product:n,auth:o,context:u})}},{key:"unlockDeviceProductFirmware",value:function(e){var t=e.deviceId,r=e.product,i=e.auth,n=e.context;return this.updateDevice({deviceId:t,desiredFirmwareVersion:null,product:r,auth:i,context:n})}},{key:"updateDevice",value:function(e){var t=e.deviceId,r=e.name,i=e.signal,n=e.notes,o=e.development,u=e.desiredFirmwareVersion,a=e.flash,s=e.product,c=e.auth,d=e.context;void 0!==i&&(i=i?"1":"0");var v=this.deviceUri({deviceId:t,product:s}),l=s?{name:r,signal:i,notes:n,development:o,desired_firmware_version:u,flash:a}:{name:r,signal:i,notes:n};return this.put(v,l,c,d)}},{key:"provisionDevice",value:function(e){var t=e.productId,r=e.auth,i=e.context;return this.post("/v1/devices",{product_id:t},r,i)}},{key:"getClaimCode",value:function(e){var t=e.iccid,r=e.product,i=e.auth,n=e.context,o=r?"/v1/products/"+r+"/device_claims":"/v1/device_claims";return this.post(o,{iccid:t},i,n)}},{key:"validatePromoCode",value:function(e){var t=e.auth,r=e.promoCode,i=e.context;return this.get("/v1/promo_code/"+r,t,void 0,i)}},{key:"changeProduct",value:function(e){var t=e.deviceId,r=e.productId,i=e.auth,n=e.context;return this.put("/v1/devices/"+t,{product_id:r},i,n)}},{key:"getVariable",value:function(e){var t=e.deviceId,r=e.name,i=e.product,n=e.auth,o=e.context,u=i?"/v1/products/"+i+"/devices/"+t+"/"+r:"/v1/devices/"+t+"/"+r;return this.get(u,n,void 0,o)}},{key:"flashDevice",value:function(e){var t=e.deviceId,r=e.product,i=e.files,n=e.targetVersion,o=e.auth,u=e.context,a=this.deviceUri({deviceId:t,product:r}),s={};return n?s.build_target_version=n:s.latest="true",this.request({uri:a,files:i,auth:o,form:s,context:u,method:"put"})}},{key:"flashTinker",value:function(e){var t=e.deviceId,r=e.auth,i=e.context;return console&&console.warning&&console.warning("Particle.flashTinker is deprecated"),this.put("/v1/devices/"+t,{app:"tinker"},r,i)}},{key:"compileCode",value:function(e){var t=e.files,r=e.platformId,i=e.targetVersion,n=e.auth,o=e.context,u={platform_id:r};return i?u.build_target_version=i:u.latest="true",this.request({uri:"/v1/binaries",method:"post",files:t,auth:n,form:u,context:o})}},{key:"downloadFirmwareBinary",value:function(e){var t=e.binaryId,r=e.auth,i=this.request({uri:"/v1/binaries/"+t,method:"get",raw:!0,auth:r});return this._provideFileData(i)}},{key:"sendPublicKey",value:function(e){var t=e.deviceId,r=e.key,i=e.algorithm,n=e.auth,o=e.context;return this.post("/v1/provisioning/"+t,{deviceID:t,publicKey:"string"==typeof r?r:r.toString(),filename:"particle-api",order:"manual_"+Date.now(),algorithm:i||"rsa"},n,o)}},{key:"callFunction",value:function(e){var t=e.deviceId,r=e.name,i=e.argument,n=e.product,o=e.auth,u=e.context,a=n?"/v1/products/"+n+"/devices/"+t+"/"+r:"/v1/devices/"+t+"/"+r;return this.post(a,{args:i},o,u)}},{key:"getEventStream",value:function(e){var t=e.deviceId,r=e.name,i=e.org,n=e.product,o=e.auth,u="/v1/";return i&&(u+="orgs/"+i+"/"),n&&(u+="products/"+n+"/"),t&&(u+="devices/","mine"!==t.toLowerCase()&&(u+=t+"/")),u+="events",r&&(u+="/"+encodeURIComponent(r)),new _EventStream2.default(""+this.baseUrl+u,o).connect()}},{key:"publishEvent",value:function(e){var t=e.name,r=e.data,i=e.isPrivate,n=e.product,o=e.auth,u=e.context,a=n?"/v1/products/"+n+"/events":"/v1/devices/events",s={name:t,data:r,private:i};return this.post(a,s,o,u)}},{key:"createWebhook",value:function(e){var t=e.deviceId,r=e.name,i=e.url,n=e.requestType,o=e.headers,u=e.json,a=e.query,s=e.body,c=e.responseTemplate,d=e.responseTopic,v=e.rejectUnauthorized,l=e.webhookAuth,h=e.noDefaults,p=e.form,f=e.product,m=e.auth,k=e.context;"mine"===t&&(t=void 0);var y=f?"/v1/products/"+f+"/webhooks":"/v1/webhooks",g={event:r,deviceid:t,url:i,requestType:n,headers:o,json:u,query:a,body:s,responseTemplate:c,responseTopic:d,rejectUnauthorized:v,auth:l,noDefaults:h,form:p};return this.post(y,g,m,k)}},{key:"deleteWebhook",value:function(e){var t=e.hookId,r=e.product,i=e.auth,n=e.context,o=r?"/v1/products/"+r+"/webhooks/"+t:"/v1/webhooks/"+t;return this.delete(o,void 0,i,n)}},{key:"listWebhooks",value:function(e){var t=e.product,r=e.auth,i=e.context,n=t?"/v1/products/"+t+"/webhooks":"/v1/webhooks";return this.get(n,r,void 0,i)}},{key:"createIntegration",value:function(e){var t=e.event,r=e.settings,i=e.deviceId,n=e.product,o=e.auth,u=e.context,a=n?"/v1/products/"+n+"/integrations":"/v1/integrations",s=(0,_assign2.default)({event:t,deviceid:i},r);return this.post(a,s,o,u)}},{key:"editIntegration",value:function(e){var t=e.integrationId,r=e.event,i=e.settings,n=e.deviceId,o=e.product,u=e.auth,a=e.context,s=o?"/v1/products/"+o+"/integrations/"+t:"/v1/integrations/"+t,c=(0,_assign2.default)({event:r,deviceid:n},i);return this.put(s,c,u,a)}},{key:"deleteIntegration",value:function(e){var t=e.integrationId,r=e.product,i=e.auth,n=e.context,o=r?"/v1/products/"+r+"/integrations/"+t:"/v1/integrations/"+t;return this.delete(o,void 0,i,n)}},{key:"listIntegrations",value:function(e){var t=e.product,r=e.auth,i=e.context,n=t?"/v1/products/"+t+"/integrations":"/v1/integrations";return this.get(n,r,void 0,i)}},{key:"getUserInfo",value:function(e){var t=e.auth,r=e.context;return this.get("/v1/user",t,void 0,r)}},{key:"setUserInfo",value:function(e){var t=e.accountInfo,r=e.auth,i=e.context,n={account_info:t};return this.put("/v1/user",n,r,i)}},{key:"changeUsername",value:function(e){var t=e.currentPassword,r=e.username,i=e.auth,n=e.context,o={current_password:t,username:r};return this.put("/v1/user",o,i,n)}},{key:"changeUserPassword",value:function(e){var t=e.currentPassword,r=e.password,i=e.invalidateTokens,n=void 0!==i&&i,o=e.auth,u=e.context,a={current_password:t,password:r};return n&&(a.invalidate_tokens=!0),this.put("/v1/user",a,o,u)}},{key:"listSIMs",value:function(e){var t=e.iccid,r=e.deviceId,i=e.deviceName,n=e.page,o=e.perPage,u=e.product,a=e.auth,s=e.context,c=u?"/v1/products/"+u+"/sims":"/v1/sims",d=u?{iccid:t,deviceId:r,deviceName:i,page:n,per_page:o}:void 0;return this.get(c,a,d,s)}},{key:"getSIMDataUsage",value:function(e){var t=e.iccid,r=e.product,i=e.auth,n=e.context,o=r?"/v1/products/"+r+"/sims/"+t+"/data_usage":"/v1/sims/"+t+"/data_usage";return this.get(o,i,void 0,n)}},{key:"getFleetDataUsage",value:function(e){var t=e.product,r=e.auth,i=e.context;return this.get("/v1/products/"+t+"/sims/data_usage",r,void 0,i)}},{key:"checkSIM",value:function(e){var t=e.iccid,r=e.auth,i=e.context;return this.head("/v1/sims/"+t,r,void 0,i)}},{key:"activateSIM",value:function(e){var t=e.iccid,r=e.iccids,i=e.country,n=e.promoCode,o=e.product,u=e.auth,a=e.context;r=r||[t];var s=o?"/v1/products/"+o+"/sims":"/v1/sims/"+t,c=o?{sims:r,country:i}:{country:i,promoCode:n,action:"activate"},d=o?"post":"put";return this.request({uri:s,method:d,data:c,auth:u,context:a})}},{key:"deactivateSIM",value:function(e){var t=e.iccid,r=e.product,i=e.auth,n=e.context,o=r?"/v1/products/"+r+"/sims/"+t:"/v1/sims/"+t,u={action:"deactivate"};return this.put(o,u,i,n)}},{key:"reactivateSIM",value:function(e){var t=e.iccid,r=e.mbLimit,i=e.product,n=e.auth,o=e.context,u=i?"/v1/products/"+i+"/sims/"+t:"/v1/sims/"+t,a={mb_limit:r,action:"reactivate"};return this.put(u,a,n,o)}},{key:"updateSIM",value:function(e){var t=e.iccid,r=e.mbLimit,i=e.product,n=e.auth,o=e.context,u=i?"/v1/products/"+i+"/sims/"+t:"/v1/sims/"+t,a={mb_limit:r};return this.put(u,a,n,o)}},{key:"removeSIM",value:function(e){var t=e.iccid,r=e.product,i=e.auth,n=e.context,o=r?"/v1/products/"+r+"/sims/"+t:"/v1/sims/"+t;return this.delete(o,void 0,i,n)}},{key:"listBuildTargets",value:function(e){var t=e.onlyFeatured,r=e.auth,i=e.context,n=void 0;return void 0!==t&&(n={featured:!!t}),this.get("/v1/build_targets",r,n,i)}},{key:"listLibraries",value:function(e){var t=e.page,r=e.limit,i=e.filter,n=e.sort,o=e.architectures,u=e.category,a=e.scope,s=e.excludeScopes,c=e.auth,d=e.context;return this.get("/v1/libraries",c,{page:t,filter:i,limit:r,sort:n,architectures:this._asList(o),category:u,scope:a,excludeScopes:this._asList(s)},d)}},{key:"_asList",value:function(e){return Array.isArray(e)?e.join(","):e}},{key:"getLibrary",value:function(e){var t=e.name,r=e.version,i=e.auth,n=e.context;return this.get("/v1/libraries/"+t,i,{version:r},n)}},{key:"getLibraryVersions",value:function(e){var t=e.name,r=e.page,i=e.limit,n=e.auth,o=e.context;return this.get("/v1/libraries/"+t+"/versions",n,{page:r,limit:i},o)}},{key:"contributeLibrary",value:function(e){var t=e.archive,r=e.auth,i=e.context,n={"archive.tar.gz":t};return this.request({uri:"/v1/libraries",method:"post",files:n,auth:r,context:i})}},{key:"publishLibrary",value:function(e){var t=e.name,r=e.auth,i=e.context;return this.request({uri:"/v1/libraries/"+t,method:"patch",data:{visibility:"public"},auth:r,context:i})}},{key:"deleteLibrary",value:function(e){var t=e.name,r=e.force,i=e.auth,n=e.context;return this.delete("/v1/libraries/"+t,{force:r},i,n)}},{key:"downloadFile",value:function(e){var t=e.url,r=this.request({uri:t,method:"get",raw:!0});return this._provideFileData(r)}},{key:"listOAuthClients",value:function(e){var t=e.product,r=e.auth,i=e.context,n=t?"/v1/products/"+t+"/clients":"/v1/clients";return this.get(n,r,void 0,i)}},{key:"createOAuthClient",value:function(e){var t=e.name,r=e.type,i=e.redirect_uri,n=e.scope,o=e.product,u=e.auth,a=e.context,s=o?"/v1/products/"+o+"/clients":"/v1/clients",c={name:t,type:r,redirect_uri:i,scope:n};return this.post(s,c,u,a)}},{key:"updateOAuthClient",value:function(e){var t=e.clientId,r=e.name,i=e.scope,n=e.product,o=e.auth,u=e.context,a=n?"/v1/products/"+n+"/clients/"+t:"/v1/clients/"+t,s={name:r,scope:i};return this.put(a,s,o,u)}},{key:"deleteOAuthClient",value:function(e){var t=e.clientId,r=e.product,i=e.auth,n=e.context,o=r?"/v1/products/"+r+"/clients/"+t:"/v1/clients/"+t;return this.delete(o,void 0,i,n)}},{key:"listProducts",value:function(e){var t=e.auth,r=e.context;return this.get("/v1/products",t,void 0,r)}},{key:"getProduct",value:function(e){var t=e.product,r=e.auth,i=e.context;return this.get("/v1/products/"+t,r,void 0,i)}},{key:"listProductFirmware",value:function(e){var t=e.product,r=e.auth,i=e.context;return this.get("/v1/products/"+t+"/firmware",r,void 0,i)}},{key:"uploadProductFirmware",value:function(e){var t=e.file,r=e.version,i=e.title,n=e.description,o=e.product,u=e.auth,a=e.context;return this.request({uri:"/v1/products/"+o+"/firmware",method:"post",files:{"firmware.bin":t},form:{version:r,title:i,description:n},context:a,auth:u})}},{key:"getProductFirmware",value:function(e){var t=e.version,r=e.product,i=e.auth,n=e.context;return this.get("/v1/products/"+r+"/firmware/"+t,i,void 0,n)}},{key:"updateProductFirmware",value:function(e){var t=e.version,r=e.title,i=e.description,n=e.product,o=e.auth,u=e.context,a="/v1/products/"+n+"/firmware/"+t;return this.put(a,{title:r,description:i},o,u)}},{key:"downloadProductFirmware",value:function(e){var t=e.version,r=e.product,i=e.auth,n=this.request({uri:"/v1/products/"+r+"/firmware/"+t+"/binary",method:"get",raw:!0,auth:i});return this._provideFileData(n)}},{key:"_provideFileData",value:function(e){return e=this.agent.isForBrowser()?e.responseType("arraybuffer").then(function(e){return e.body=e.xhr.response,e}):e.buffer(!0).parse(_superagentBinaryParser2.default),e.then(function(e){return e.body})}},{key:"releaseProductFirmware",value:function(e){var t=e.version,r=e.product,i=e.auth,n=e.context,o="/v1/products/"+r+"/firmware/release";return this.put(o,{version:t},i,n)}},{key:"listTeamMembers",value:function(e){var t=e.product,r=e.auth,i=e.context;return this.get("/v1/products/"+t+"/team",r,void 0,i)}},{key:"inviteTeamMember",value:function(e){var t=e.username,r=e.product,i=e.auth,n=e.context;return this.post("/v1/products/"+r+"/team",{username:t},i,n)}},{key:"removeTeamMember",value:function(e){var t=e.username,r=e.product,i=e.auth,n=e.context;return this.delete("/v1/products/"+r+"/team/"+t,void 0,i,n)}},{key:"lookupSerialNumber",value:function(e){var t=e.serialNumber,r=e.auth,i=e.context;return this.get("/v1/serial_numbers/"+t,r,void 0,i)}},{key:"createMeshNetwork",value:function(e){var t=e.name,r=e.deviceId,i=e.iccid,n=e.auth,o=e.context;return this.post("/v1/networks",{name:t,device_id:r,iccid:i},n,o)}},{key:"removeMeshNetwork",value:function(e){var t=e.networkId,r=e.auth,i=e.context;return this.delete("/v1/networks/"+t,void 0,r,i)}},{key:"listMeshNetworks",value:function(e){var t=e.auth,r=e.context,i=e.page,n=e.perPage,o=i?{page:i,per_page:n}:void 0;return this.get("/v1/networks",t,o,r)}},{key:"getMeshNetwork",value:function(e){var t=e.networkId,r=e.auth,i=e.context;return this.get("/v1/networks/"+t,r,void 0,i)}},{key:"updateMeshNetwork",value:function(e){var t=e.networkId,r=e.action,i=e.deviceId,n=e.auth,o=e.context;return this.put("/v1/networks/"+t,{action:r,device_id:i},n,o)}},{key:"addMeshNetworkDevice",value:function(e){var t=e.networkId,r=e.deviceId,i=e.auth,n=e.context;return this.updateMeshNetwork({action:"add-device",networkId:t,deviceId:r,auth:i,context:n})}},{key:"removeMeshNetworkDevice",value:function(e){var t=e.networkId,r=e.deviceId,i=e.auth,n=e.context;return t?this.updateMeshNetwork({action:"remove-device",networkId:t,deviceId:r,auth:i,context:n}):this.delete("/v1/devices/"+r+"/network",void 0,i,n)}},{key:"listMeshNetworkDevices",value:function(e){var t=e.networkId,r=e.auth,i=e.role,n=e.page,o=e.perPage,u=e.context,a=i||n?{role:i,page:n,per_page:o}:void 0;return this.get("/v1/networks/"+t+"/devices",r,a,u)}},{key:"deviceUri",value:function(e){var t=e.deviceId,r=e.product;return r?"/v1/products/"+r+"/devices/"+t:"/v1/devices/"+t}},{key:"get",value:function(e,t,r,i){return i=this._buildContext(i),this.agent.get(e,t,r,i)}},{key:"head",value:function(e,t,r,i){return i=this._buildContext(i),this.agent.head(e,t,r,i)}},{key:"post",value:function(e,t,r,i){return i=this._buildContext(i),this.agent.post(e,t,r,i)}},{key:"put",value:function(e,t,r,i){return i=this._buildContext(i),this.agent.put(e,t,r,i)}},{key:"delete",value:function(e,t,r,i){return i=this._buildContext(i),this.agent.delete(e,t,r,i)}},{key:"request",value:function(e){return e.context=this._buildContext(e.context),this.agent.request(e)}},{key:"client",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return new _Client2.default((0,_assign2.default)({api:this},e))}}]),e}();Particle.prototype.removeAccessToken=Particle.prototype.deleteAccessToken,exports.default=Particle,module.exports=exports.default;
    ...
    },{"base64-js":26,"ieee754":139,"isarray":142}],29:[function(require,module,exports){
    ...
    },{"./_stream_readable":152,"./_stream_writable":154,"core-util-is":136,"inherits":140,"process-nextick-args":143}],151:[function(require,module,exports){
    ...
    },{"./_stream_transform":153,"core-util-is":136,"inherits":140}],152:[function(require,module,exports){
    ...
    },{"./_stream_duplex":150,"./internal/streams/BufferList":155,"./internal/streams/destroy":156,"./internal/streams/stream":157,"_process":144,"core-util-is":136,"events":137,"inherits":140,"isarray":142,"process-nextick-args":143,"safe-buffer":162,"string_decoder/":168,"util":27}],153:[function(require,module,exports){
    ...
    },{"./_stream_duplex":150,"core-util-is":136,"inherits":140}],154:[function(require,module,exports){
    (function (process,global){
    ...
    },{"./_stream_duplex":150,"./internal/streams/destroy":156,"./internal/streams/stream":157,"_process":144,"core-util-is":136,"inherits":140,"process-nextick-args":143,"safe-buffer":162,"util-deprecate":180}],155:[function(require,module,exports){
    ...
    },{"process-nextick-args":143}],157:[function(require,module,exports){
    module.exports=require("events").EventEmitter;
    },{"events":137}],158:[function(require,module,exports){
    ...
    },{"buffer":28}],163:[function(require,module,exports){
    ...
    },{"events":137,"inherits":140,"readable-stream/duplex.js":149,"readable-stream/passthrough.js":158,"readable-stream/readable.js":159,"readable-stream/transform.js":160,"readable-stream/writable.js":161}],164:[function(require,module,exports){
    (function (global){
    ...
    },{"./lib/request":166,"builtin-status-codes":29,"url":178,"xtend":181}],165:[function(require,module,exports){
    (function (global){
    ...
    },{"./capability":165,"./response":167,"_process":144,"buffer":28,"inherits":140,"stream":163,"to-arraybuffer":177}],167:[function(require,module,exports){
    (function (process,global,Buffer){
    ...
    },{"./capability":165,"_process":144,"buffer":28,"inherits":140,"stream":163}],168:[function(require,module,exports){
    ...
    },{"./agent-base":170,"./is-object":172,"./request-base":173,"./response-base":174,"component-emitter":176,"fast-safe-stringify":138}],172:[function(require,module,exports){
    ...
    },{"buffer":28}],178:[function(require,module,exports){
    ...
    },{"./util":179,"punycode":145,"querystring":148}],179:[function(require,module,exports){
